<template>
  <div class="cartItem relative mb-4 flex w-full items-center justify-between gap-2 border-b py-6">
    <!-- checkbox -->
    <input
      type="checkbox"
    ...
    >
      ...
      <div class="flex flex-1 justify-between gap-6">
        <!-- qty -->
        <div class="flex-1">
          <div class="flex h-full w-[90px] items-center border font-medium md:h-9 md:w-[120px]">
            <!-- minus icon -->
            <button
